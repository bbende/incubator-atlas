...
package org.apache.atlas.nifi.model;
...
public class NiFiDataModelGenerator {
    ...
    private void createFlowControllerClass() throws AtlasException {
        ...
        addClassTypeDefinition(typeName, ImmutableList.of(AtlasClient.REFERENCEABLE_SUPER_TYPE), new AttributeDefinition[] {});
    ...
    private void createProcessGroupClass() throws  AtlasException {
        ...
        addClassTypeDefinition(typeName, ImmutableList.of(AtlasClient.REFERENCEABLE_SUPER_TYPE), attributeDefinitions);
        LOG.debug("Created definition for " + typeName);
    }
    ...
    private void createConnectionClass() throws AtlasException {
        final String typeName = NiFiDataTypes.NIFI_CONENCTION.getName();
    ...
    private void addClassTypeDefinition(String typeName, ImmutableList<String> superTypes, AttributeDefinition[] attributeDefinitions) {
        final HierarchicalTypeDefinition<ClassType> definition =
                new HierarchicalTypeDefinition<>(ClassType.class, typeName, superTypes, attributeDefinitions);
